...
public enum ListenerType {
  ...
  LISTENER_IDENTIFIER_LISTENER(ChannelType.LISTENER, MessageType.Listener.IDENTIFIER_LISTENER, ChannelListenerMessage.class, Tuple.class),
  LISTENER_MESSAGE_TYPE_LISTENER(ChannelType.LISTENER, MessageType.Listener.MESSAGE_TYPE_LISTENER, ChannelListenerMessage.class, Tuple.class),
  LISTENER_REGISTER(ChannelType.LISTENER, MessageType.Listener.REGISTER_SERVER, ChannelListenerMessage.class, Integer.class),
  LISTENER_UNREGISTER(ChannelType.LISTENER, MessageType.Listener.UNREGISTER_SERVER, ChannelListenerMessage.class, Integer.class),
  ...
  LOGGING_INFO(ChannelType.LOGGING, MessageType.Logging.INFO, ChannelLoggingMessage.class, String.class),
  LOGGING_WARNING(ChannelType.LOGGING, MessageType.Logging.WARNING, ChannelLoggingMessage.class, String.class),
  LOGGING_ERROR(ChannelType.LOGGING, MessageType.Logging.ERROR, ChannelLoggingMessage.class, String.class),
