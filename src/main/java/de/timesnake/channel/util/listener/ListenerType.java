...
public enum ListenerType {
    ...
    SERVER_STATUS(ChannelType.SERVER, MessageType.Server.STATUS, ChannelServerMessage.class, Integer.class), SERVER_ONLINE_PLAYERS(ChannelType.SERVER, MessageType.Server.ONLINE_PLAYERS, ChannelServerMessage.class, Integer.class), SERVER_MAX_PLAYERS(ChannelType.SERVER, MessageType.Server.MAX_PLAYERS, ChannelServerMessage.class, Integer.class), SERVER_COMMAND(ChannelType.SERVER, MessageType.Server.COMMAND, ChannelServerMessage.class, Integer.class), SERVER_PERMISSION(ChannelType.SERVER, MessageType.Server.PERMISSION, ChannelServerMessage.class, Integer.class), SERVER_MAP(ChannelType.SERVER, MessageType.Server.MAP, ChannelServerMessage.class, Integer.class), SERVER_OLD_PVP(ChannelType.SERVER, MessageType.Server.OLD_PVP, ChannelServerMessage.class, Integer.class), SERVER_PASSWORD(ChannelType.SERVER, MessageType.Server.PASSWORD, ChannelServerMessage.class, Integer.class), SERVER_STATE(ChannelType.SERVER, MessageType.Server.STATE, ChannelServerMessage.class, Integer.class), SERVER_CUSTOM(ChannelType.SERVER, MessageType.Server.CUSTOM, ChannelServerMessage.class, Integer.class), SERVER_RESTART(ChannelType.SERVER, MessageType.Server.RESTART, ChannelServerMessage.class, Integer.class), SERVER_DISCORD(ChannelType.SERVER, MessageType.Server.DISCORD, ChannelServerMessage.class, Integer.class),

    SERVER(ChannelType.SERVER, null, ChannelServerMessage.class, Integer.class),


    USER_STATUS(ChannelType.USER, MessageType.User.STATUS, ChannelUserMessage.class, UUID.class), USER_SERVICE(ChannelType.USER, MessageType.User.SERVICE, ChannelUserMessage.class, UUID.class), USER_SWITCH_PORT(ChannelType.USER, MessageType.User.SWITCH_PORT, ChannelUserMessage.class, UUID.class), USER_SWITCH_NAME(ChannelType.USER, MessageType.User.SWITCH_NAME, ChannelUserMessage.class, UUID.class), USER_PERMISSION(ChannelType.USER, MessageType.User.PERMISSION, ChannelUserMessage.class, UUID.class), USER_PUNISH(ChannelType.USER, MessageType.User.PUNISH, ChannelUserMessage.class, UUID.class), USER_ALIAS(ChannelType.USER, MessageType.User.ALIAS, ChannelUserMessage.class, UUID.class), USER_TASK(ChannelType.USER, MessageType.User.TASK, ChannelUserMessage.class, UUID.class), USER_COMMAND(ChannelType.USER, MessageType.User.COMMAND, ChannelUserMessage.class, UUID.class), USER_GROUP(ChannelType.USER, MessageType.User.GROUP, ChannelUserMessage.class, UUID.class), USER_TEAM(ChannelType.USER, MessageType.User.TEAM, ChannelUserMessage.class, UUID.class), USER_STATISTICS(ChannelType.USER, MessageType.User.STATISTICS, ChannelUserMessage.class, UUID.class), USER_CUSTOM(ChannelType.USER, MessageType.User.CUSTOM, ChannelUserMessage.class, UUID.class), USER_SOUND(ChannelType.USER, MessageType.User.SOUND, ChannelUserMessage.class, UUID.class),
